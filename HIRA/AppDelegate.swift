...
//  HIRA
//
//  Created by Debashis  on 13/11/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var globalBackButton:UIBarButtonItem?

    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        // Override point for customization after application launch.
        UIApplication.shared.statusBarStyle = .lightContent
        if (UserDefaults.standard.value(forKey: "isShiftStarted") == nil){
            UserDefaults.standard.set(false, forKey: "isShiftStarted")
        }
        if UserDefaults.standard.value(forKey: "x_auth_token") != nil && UserDefaults.standard.value(forKey: "current_user_id") != nil {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "HIRA")
